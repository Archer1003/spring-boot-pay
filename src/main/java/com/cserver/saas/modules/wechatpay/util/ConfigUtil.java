...
public class ConfigUtil {
	 ...
	 *
	 */
	public static void commonParams(SortedMap<String, Object> packageParams) {
		packageParams.put("appid", ConfigUtil.APP_ID);// 公众账号ID
		packageParams.put("mch_id",  ConfigUtil.MCH_ID);// 商户号
		packageParams.put("nonce_str", EncryptUtil.random());// 随机字符串
	}
	...
	public static void shorturl(String urlCode) {
		try {
			...
			String sign = SignUtil.sign(packageParams, API_KEY);
			packageParams.put("sign", sign);// 签名
			String requestXML = XmlUtil.toXml(packageParams);
